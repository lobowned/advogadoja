...
export const areaCalculatorMap: Record<string, CalculatorType[]> = {
  ...
  consumidor: ['voo-cancelado', 'negativacao', 'devolucao-dobro', 'plano-saude', 'fraude-bancaria', 'danos-morais'],
  penal: [],
  geral: []
};
...
const keywordCalculatorMap: Record<string, CalculatorType> = {
  ...
  'atraso de voo': 'voo-cancelado',
  'overbooking': 'voo-cancelado',
  'bagagem extraviada': 'voo-cancelado',
  'companhia aérea': 'voo-cancelado',
  'negativação': 'negativacao',
  'negativacao': 'negativacao',
  'nome sujo': 'negativacao',
  'serasa': 'negativacao',
  'spc': 'negativacao',
  'nome negativado': 'negativacao',
  'devolução em dobro': 'devolucao-dobro',
  'devolucao em dobro': 'devolucao-dobro',
  'cobrança indevida': 'devolucao-dobro',
  'cobranca indevida': 'devolucao-dobro',
  'cobrado indevidamente': 'devolucao-dobro',
  'plano de saúde': 'plano-saude',
  'plano de saude': 'plano-saude',
  'negativa de cobertura': 'plano-saude',
  'cirurgia negada': 'plano-saude',
  'operadora de saúde': 'plano-saude',
  'fraude bancária': 'fraude-bancaria',
  'fraude bancaria': 'fraude-bancaria',
  'golpe pix': 'fraude-bancaria',
  'cartão clonado': 'fraude-bancaria',
  'cartao clonado': 'fraude-bancaria',
  'empréstimo fraudulento': 'fraude-bancaria',
  'conta invadida': 'fraude-bancaria',
};
