...
/**
 * Esconde o FloatingWhatsApp original (verde) quando o usuário está em rotas que têm o SEU PRÓPRIO
 * WhatsApp flutuante dourado: /prev e /riccioadvocacia. Evita dois botões sobrepostos no mobile.
 */
