  ...
  return (
    <>
      ...
      <PrevLayout ctaMessage={WHATSAPP_MESSAGES.aposentadorias} quizKey="aposentadorias">
        ...
        <PrevHeroSplit
          breadcrumb="Aposentadorias"
          heroTitle={
            <>
              Existem <span className="italic text-prev-gold">5 caminhos</span>{" "}
              pra aposentar.
              <br /> Qual é o seu?
            </>
          }
          heroSubtitle="Depois da Reforma de 2019, escolher errado pode te fazer perder muito dinheiro — todo mês, pelo resto da vida. A gente olha junto seu CNIS e mostra qual aposentadoria é a melhor pro seu caso."
