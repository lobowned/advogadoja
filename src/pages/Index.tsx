...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Footer */}
      <footer className="border-t bg-muted/30 py-8 sm:py-10 safe-bottom">
            ...
            <div className="flex flex-col items-center md:items-end gap-3">
              <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4">
                <a 
                  ...
                  className="hover:text-whatsapp-send-btn transition-colors flex items-center gap-2 py-2 min-h-[48px]"
                >
                ...
                <a 
                  ...
                  className="hover:text-primary transition-colors flex items-center gap-2 py-2 min-h-[48px]"
                >
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 text-xs">
                <a href="#" className="hover:text-foreground transition-colors py-2 min-h-[44px] flex items-center justify-center">Política de Privacidade</a>
                <a href="#" className="hover:text-foreground transition-colors py-2 min-h-[44px] flex items-center justify-center">Termos de Uso</a>
              </div>
            </div>
          </div>
        </div>
