        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-2 md:order-1">
              <div className="aspect-[3/4] bg-gradient-to-br from-primary to-primary/80 rounded-lg shadow-elegant relative overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/50 to-transparent p-6">
                  <p className="text-white font-semibold text-lg">Advogado Especializado</p>
                  <p className="text-white/80 text-sm">OAB/XX 000.000</p>
                </div>
              </div>
            </div>
