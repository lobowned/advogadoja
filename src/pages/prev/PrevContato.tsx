      ...
      <PrevLayout ctaMessage={WHATSAPP_MESSAGES.contato}>
        <section className="bg-prev-navy text-prev-beige pt-16 pb-20 lg:pt-24">
          <div className="max-w-4xl mx-auto px-5">
            <p className="text-xs uppercase tracking-[0.18em] text-prev-gold mb-4">Contato</p>
            <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl leading-[1.05] tracking-tight mb-6">
              Vamos conversar sobre <span className="italic text-prev-gold">o seu caso</span>.
            </h1>
            <p className="text-lg text-prev-beige/80 leading-relaxed max-w-2xl">
              A forma mais rápida é pelo WhatsApp. Se preferir, deixe sua mensagem pelo formulário.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 bg-prev-beige">
          <div className="max-w-5xl mx-auto px-5">
            <div className="grid md:grid-cols-3 gap-6 mb-16">
              ...
              >
                <div className="w-12 h-12 rounded-xl bg-prev-gold/15 flex items-center justify-center mb-5">
                ...
                <p className="text-prev-navy/70 text-sm">Conte rapidamente sua situação.</p>
              </motion.a>
              ...
              >
                ...
                <p className="text-prev-navy/70 text-sm break-all">{LAWYER.email}</p>
              </motion.a>
              ...
              <div className="max-w-2xl mx-auto">
                ...
                {submitted ? (
                  <div className="text-center py-10">
                    ...
                    <h3 className="font-serif text-xl text-prev-navy mb-2">Mensagem encaminhada</h3>
                    <p className="text-prev-navy/65 text-sm">Se o WhatsApp não abriu, verifique o bloqueador de popup.</p>
                  </div>
                ) : (
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div className="grid sm:grid-cols-2 gap-5">
                      <label className="block">
                        <span className="text-xs text-prev-navy/70 font-medium block mb-2">Seu nome</span>
                        <input
                          required
                          type="text"
                          value={form.name}
                      ...
                      <label className="block">
                        <span className="text-xs text-prev-navy/70 font-medium block mb-2">Telefone (com DDD)</span>
                        <input
                          required
                          type="tel"
                          value={form.phone}
                    ...
                    <label className="block">
                      <span className="text-xs text-prev-navy/70 font-medium block mb-2">Assunto</span>
                      <select
                        value={form.topic}
                    ...
                    <label className="block">
                      <span className="text-xs text-prev-navy/70 font-medium block mb-2">Conte rapidamente seu caso</span>
                      <textarea
                        required
                        rows={5}
                        value={form.message}
                        onChange={(e) => setForm({ ...form, message: e.target.value })}
                        className="w-full px-4 py-2.5 rounded-lg border border-prev-navy/15 bg-white text-prev-navy focus:outline-none focus:border-prev-gold focus:ring-2 focus:ring-prev-gold/20 resize-none"
                      />
                    </label>
