              ...
              {!hasJoinedQueue ? (
                <div className="flex items-center justify-center h-full">
                  <div className="text-center max-w-md px-3">
                    ...
                    >
                      {/* Botão Iniciar Atendimento - Gradiente Premium */}
                      <Button
                        onClick={() => joinQueue()}
                      ...
                      <Button
                        asChild
                        className="flex-1 bg-[#25D366] hover:bg-[#20BD5A] text-white font-semibold py-5 sm:py-6 text-base sm:text-lg rounded-xl transition-all duration-300 flex items-center justify-center gap-3 min-h-[56px] shadow-lg shadow-green-500/20 hover:shadow-xl hover:shadow-green-500/30 hover:scale-[1.02]"
                      >
                        <a 
                        ...
                        >
                          ...
                          <span className="bg-white/20 text-xs px-2 py-0.5 rounded-full">Online</span>
                        </a>
                      </Button>
                    </div>
                  </div>
